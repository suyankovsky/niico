    ...
    <div class="niico-header">
        <template v-if="is_mini_player_mode">
            <div class="miniPlayerModeHeader">
                <div class="iconButton" @click="requestDefaultScreenMode"><MaximizeIcon /></div>
                <div
                    class="handle"
                    @mousedown="moveStartMiniPlayer"
                ><HandleIcon /></div>
                <div class="iconButton" @click="toggleIsShowNiicoFloatWindow" data-js-id="toggleNiicoFloatWindowButton">
