...
import Stage from 'js/content/lib/flow-comment/stage.js';
import Layer from 'js/content/lib/flow-comment/layer.js';
import Comment from 'js/content/lib/flow-comment/comment.js'
